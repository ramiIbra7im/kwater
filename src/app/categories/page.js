...
export default function Categories({
    ...
    // ✅ استخدمنا useState داخلي علشان نسيطر على الـ state
    const [internalSelectedCategory, setInternalSelectedCategory] = useState(externalSelectedCategory || "");

    // ✅ sync between internal and external state
    useEffect(() => {
    ...
    const handleCategoryClick = (categoryValue) => {
        ...
        // ✅ إذا الـ external function موجودة، استخدمها كمان
        if (typeof externalSetSelectedCategory === 'function') {
            externalSetSelectedCategory(categoryValue);
        }
    };
    ...
    const handleResetFilters = () => {
        ...
        // ✅ Reset external states إذا موجودة
    ...
    const isCategoryActive = (categoryValue) => {
        // ✅ استخدم الـ internal state للتحقق من النشاط
        return internalSelectedCategory === categoryValue;
    };

    if (isLoading) {
        return (
            <div className="bg-white shadow-lg rounded-3xl p-6 h-full">
                <div className="mb-8">
    ...
    return (
        <div className="bg-white shadow-lg rounded-3xl p-6 h-full">
            ...
            <div className="mb-6">
                ...
                {(searchTerm || internalSelectedCategory) && (
                    <button
