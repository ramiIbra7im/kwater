...
//     if (isLoading) {
//         return (
//             <aside className="hidden xl:block w-80 shrink-0 h-[calc(100vh-80px)] sticky top-20 bg-linear-to-b from-white to-amber-50/30 shadow-xl rounded-3xl p-6 overflow-y-auto border border-amber-100">
